...
const JobsExperience = () => {
  return (
    <section className="mx-auto flex w-11/12 flex-col gap-y-2 md:w-9/12 lg:w-10/12 lg:gap-y-8 xl:w-9/12">
      <h2 className="py-12 text-5xl font-bold ">Work Experience:</h2>
        ...
        {jobs.map((job) => {
          return (
            <li
              ...
              key={job.name}
            >
              <p className="flex h-24 w-24 items-center justify-center rounded-full border-8 border-slate-400 bg-slate-900 text-center text-5xl font-bold text-slate-200 dark:bg-slate-200 dark:text-slate-900 xl:h-32 xl:w-32 xl:text-6xl">
                {job.logo}
              </p>
